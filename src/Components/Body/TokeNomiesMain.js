    ...
    useEffect(()=>{
      ...
      return(
        ...
        <p className="TokemoniesHead" onClick={()=>setActive('totalsupply')}>{headRename}</p>
            <div className="row">
                <div className="col-lg-6 col-md-12 col-sm-12" style={{marginBottom: "50px"}}>
            ...
            {active === 'Public' ?
                <div className="totalsupply">
                    <img className="totalsupplyimage2" src={publicPic} alt="investor"/>
                </div>
                : ""
                }
